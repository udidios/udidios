...
function showPlayer(num, id) {
    if (num == 1) {
        ...
        document.getElementById('Content-img').innerHTML = '<iframe class="iframe" src="https://player.cdnvideohub.com/playerjs?partner=1&kid=' + id + '" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" seamless></iframe>';
    } else if (num == 3) {
        ...
        document.getElementById('Content-img').innerHTML = '<iframe class="iframe" src="http://voidboost.tv/embed/' + id + '" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" seamless></iframe>';
    } else if (num == 7) {
        ...
        .then(function (obj) {
            ...
            <div class="dropdown" id="dropdown" style="display: inline-flex;">\
                ...
                <div id="show_pl" class="dropdown-content" style="text-align: left;">\
                    ...
                    <a onclick="showPlayer(2,\'' + obj['kinopoisk_id'] + '\')">Плеер #2 <span style="font-size:6px">(CDNmovies)</span></a>\
                    <a onclick="showPlayer(3,\'' + obj['kinopoisk_id'] + '\')">Плеер #3 <span style="font-size:6px">(DBHDVB)</span></a>\
                    <a onclick="showPlayer(4,\'' + obj['imdb_id'] + '\')">Плеер #4 <span style="font-size:6px">(VideoDB)</span></a>\
                    <a onclick="showPlayer(5,\'' + obj['kinopoisk_id'] + '\')">Плеер #5 <span style="font-size:6px">(Alloha)</span></a>\
                    <a onclick="showPlayer(6,\'' + obj['kinopoisk_id'] + '\')">Плеер #6 <span style="font-size:6px">(HDRezha)</span></a>\
                    <a onclick="showPlayer(7,\'' + obj['imdb_id'] + '\')">Плеер #7 <span style="font-size:6px">(VideoCDN)</span></a>\
                    <a onclick="showPlayer(8,\'' + obj['kinopoisk_id'] + '\')">Плеер #8 <span style="font-size:6px">(KodikBD)</span></a>\
                ...
                <div id="show_tr" class="dropdown-content" style="text-align: left;left: 175px;">\
                    ...
                    <a onclick="showTrayler(5,\'' + obj['kinopoisk_id'] + '\')">Трейлер #5 <span style="font-size:6px">(Кинопоиск)</span></a>\
                </div>\
            </div>\
